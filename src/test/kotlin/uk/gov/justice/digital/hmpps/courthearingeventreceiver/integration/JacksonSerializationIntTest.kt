...
class JacksonSerializationIntTest : IntegrationTestBase() {
  ...
  @Test
  fun `should handle null caseURN in ProsecutionCaseIdentifier`() {
    // Test case for production incident where caseURN can be null
    val json = """
      {
        "hearing": {
          "id": "test-hearing-id",
          ...
          "hearingDays": [{
            "sittingDay": "2026-04-01T09:00:00.000Z",
          ...
          "prosecutionCases": [{
            ...
            "prosecutionCaseIdentifier": {
              "prosecutionAuthorityCode": "AUTH123",
              "prosecutionAuthorityId": "ID456",
              "caseURN": null
            },
            "defendants": [{
              "id": "def-id",
    ...
    // Verify that null caseURN is properly handled
    assertThat(hearingEvent.hearing.prosecutionCases).isNotEmpty()
    val prosecutionCaseIdentifier = hearingEvent.hearing.prosecutionCases[0].prosecutionCaseIdentifier
    assertThat(prosecutionCaseIdentifier.caseURN).isNull()
    assertThat(prosecutionCaseIdentifier.prosecutionAuthorityCode).isEqualTo("AUTH123")
    assertThat(prosecutionCaseIdentifier.prosecutionAuthorityId).isEqualTo("ID456")
  }
}
