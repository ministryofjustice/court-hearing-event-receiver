...
internal class ModelParserTest {
  ...
  fun `tests the parsing of JSON to the model`() {
    ...
    assertThat(hearing.courtCentre.name).isEqualTo("Liverpool Crown Court")
    assertThat(hearing.courtCentre.lja!!.ljaCode).isEqualTo("2577")
    assertThat(hearing.courtCentre.lja!!.ljaName).isEqualTo("South West London Magistrates' Court")
    assertThat(hearing.courtCentre.address!!.address1).isEqualTo("176A Lavender Hill")
    assertThat(hearing.courtCentre.address!!.address2).isEqualTo("London")
    assertThat(hearing.courtCentre.address!!.address3).isEqualTo("England")
    assertThat(hearing.courtCentre.address!!.address4).isEqualTo("UK")
    assertThat(hearing.courtCentre.address!!.address5).isEqualTo("ABC")
    assertThat(hearing.courtCentre.address!!.postcode).isEqualTo("SW11 1JU")
    ...
    assertThat(hearing.prosecutionCases[0].defendants[0].isYouth).isEqualTo(false)
    ...
    assertThat(hearing.prosecutionCases[0].defendants[1].isYouth).isEqualTo(true)
    ...
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].orderedDate).isEqualTo(LocalDate.of(2024, Month.OCTOBER, 21))
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].courtExtract).isEqualTo("Y")
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].isDurationEndDate).isEqualTo(true)
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].isFinancialImposition).isEqualTo(false)
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].judicialResultPromptTypeId).isEqualTo("20fe3e69-c7d6-4f72-8b77-13c70c1f986d")
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].label).isEqualTo("Number of days to abstain from consuming any alcohol")
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].promptReference).isEqualTo("numberOfDaysToAbstainFromConsumingAnyAlcohol")
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].promptSequence).isEqualTo(100)
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].type).isEqualTo("INT")
    assertThat(hearing.prosecutionCases[0].defendants[0].offences[0].judicialResults[0].judicialResultPrompts[0].value).isEqualTo("120")
    ...
    assertThat(hearing.prosecutionCases[0].defendants[0].aliases!![0].title).isEqualTo("MR")
    assertThat(hearing.prosecutionCases[0].defendants[0].aliases!![0].firstName).isEqualTo("John")
    assertThat(hearing.prosecutionCases[0].defendants[0].aliases!![0].middleName).isEqualTo("Smith")
    assertThat(hearing.prosecutionCases[0].defendants[0].aliases!![0].lastName).isEqualTo("Doe")
    assertThat(hearing.prosecutionCases[0].defendants[0].aliases!![0].legalEntityName).isEqualTo("John Smith Co")
